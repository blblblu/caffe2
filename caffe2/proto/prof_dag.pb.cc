...
namespace protobuf_prof_5fdag_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "prof_dag.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
ProfDAGProto::ProfDAGProto()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_prof_5fdag_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* ProfDAGProto::descriptor() {
  protobuf_prof_5fdag_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_prof_5fdag_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata ProfDAGProto::GetMetadata() const {
  protobuf_prof_5fdag_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_prof_5fdag_2eproto::file_level_metadata[kIndexInFileMessages];
}
